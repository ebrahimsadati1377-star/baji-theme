...
if(21===(int)$category->term_id || 'مانتو'===$category->name){$image_url='https://bajistyle.ir/wp-content/uploads/2026/09/baji-category-manto-full-reference-v2.png?v=2699';}
