...
<div class="baji-smart-promo baji-snapppay-banner" aria-label="خرید اقساطی با اسنپ‌پی">
  <div class="baji-snapppay-banner__inner">
    <div class="baji-snapppay-banner__brand" aria-label="Snapp Pay">
      <span class="baji-snapppay-banner__logo">Snapp!</span>
      <strong>Pay</strong>
    </div>
    <div class="baji-snapppay-banner__copy">
      <span class="baji-snapppay-banner__eyebrow">خرید اقساطی از باجی</span>
      <strong>الان بخر، در ۴ قسط پرداخت کن</strong>
      <small>بدون کارمزد با اعتبار اسنپ‌پی</small>
    </div>
    <div class="baji-snapppay-banner__benefits" aria-hidden="true">
      <span><i class="fa-solid fa-4"></i><small>قسط</small></span>
      <span><i class="fa-solid fa-percent"></i><small>بدون کارمزد</small></span>
    </div>
    <a class="baji-snapppay-banner__cta" href="<?php echo esc_url( class_exists('WooCommerce') ? wc_get_page_permalink('shop') : home_url('/') ); ?>">
      <span>خرید</span>
