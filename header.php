...
if ( isset( $_GET['baji_snapp_strip_purge'] ) ) {
...
<div class="baji-smart-promo baji-snapp-strip" aria-label="خرید اقساطی با اسنپ‌پی">
  <div class="baji-smart-promo-viewport baji-snapp-strip__viewport">
    <a class="baji-smart-promo-slide baji-snapp-strip__slide is-active" href="<?php echo esc_url( class_exists('WooCommerce') ? wc_get_page_permalink('shop') : home_url('/') ); ?>">
      <span class="baji-snapp-strip__message">الان بخر، بعداً پرداخت کن</span>
      <span class="baji-snapp-strip__brand" aria-label="Snapp Pay"><b>Snapp!</b><i>Pay</i></span>
      <span class="baji-snapp-strip__buy">خرید</span>
    </a>
    <a class="baji-smart-promo-slide baji-snapp-strip__slide" href="<?php echo esc_url( class_exists('WooCommerce') ? wc_get_page_permalink('shop') : home_url('/') ); ?>">
      <span class="baji-snapp-strip__message">۴ قسط، بدون کارمزد</span>
      <span class="baji-snapp-strip__brand" aria-label="Snapp Pay"><b>Snapp!</b><i>Pay</i></span>
      <span class="baji-snapp-strip__buy">خرید</span>
    </a>
    <a class="baji-smart-promo-slide baji-snapp-strip__slide" href="<?php echo esc_url( class_exists('WooCommerce') ? wc_get_page_permalink('shop') : home_url('/') ); ?>">
      <span class="baji-snapp-strip__message">خرید اقساطی با اعتبار اسنپ‌پی</span>
      <span class="baji-snapp-strip__brand" aria-label="Snapp Pay"><b>Snapp!</b><i>Pay</i></span>
      <span class="baji-snapp-strip__buy">خرید</span>
    </a>
  </div>
