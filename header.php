...
<div class="baji-smart-promo" aria-label="خرید اقساطی باجی">
  <div class="baji-smart-promo-viewport">
    <div class="baji-smart-promo-slide is-active">
      <strong>خرید اقساطی از باجی</strong>
      <span class="baji-smart-promo-sub">۴ قسط بدون کارمزد</span>
      <span class="baji-pay-logos" aria-label="روش‌های پرداخت اقساطی">
        <span class="baji-pay-logo baji-pay-logo--snapp">Snapp! Pay</span>
        <span class="baji-pay-logo baji-pay-logo--torob">ترب‌پی</span>
        <span class="baji-pay-logo baji-pay-logo--digi">دیجی‌پی</span>
      </span>
    </div>
    <div class="baji-smart-promo-slide">
      <strong>امروز بخر، بعداً پرداخت کن</strong>
      <span class="baji-smart-promo-sub">پرداخت راحت در ۴ قسط</span>
      <span class="baji-pay-logos">
        <span class="baji-pay-logo baji-pay-logo--snapp">Snapp! Pay</span>
        <span class="baji-pay-logo baji-pay-logo--torob">ترب‌پی</span>
        <span class="baji-pay-logo baji-pay-logo--digi">دیجی‌پی</span>
      </span>
    ...
    <div class="baji-smart-promo-slide">
      <strong>استایل امروز، پرداخت فردا</strong>
      <span class="baji-smart-promo-sub">با اسنپ‌پی، ترب‌پی و دیجی‌پی</span>
      <span class="baji-pay-logos">
        <span class="baji-pay-logo baji-pay-logo--snapp">Snapp! Pay</span>
        <span class="baji-pay-logo baji-pay-logo--torob">ترب‌پی</span>
        <span class="baji-pay-logo baji-pay-logo--digi">دیجی‌پی</span>
  ...
  <div class="baji-smart-promo-dots" aria-hidden="true"><i class="is-active"></i><i></i><i></i></div>
</div>
