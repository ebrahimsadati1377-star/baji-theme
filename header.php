...
<input type="checkbox" id="baji-menu-state" aria-hidden="true">
...
<div class="sticky top-0 z-50 w-full"><header id="masthead" class="baji-header bg-baji-white border-b border-gray-100"><div class="baji-header-inner max-w-[1400px] mx-auto px-4 md:px-8"><div class="flex items-center justify-between h-20 md:h-24 relative">
<label for="baji-menu-state" id="baji-mobile-menu-toggle" class="baji-mobile-menu-toggle md:hidden flex flex-col gap-1.5 p-2" role="button" aria-label="باز کردن منو"><span class="block w-6 h-px bg-current"></span><span class="block w-6 h-px bg-current"></span><span class="block w-6 h-px bg-current"></span></label>
